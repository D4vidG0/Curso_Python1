...
# caso2 = Ejercicios.aparicion_caracteres("Holalapaeare++3333") #funciona tambien caracteres especiales y numeros
# print(caso2)
...
# string = input("Ingrese la secuencia separado por comas: \n")
# caso3 = Ejercicios.devolver_lista_tupla(string)
# print(caso3[0])
# print(caso3[1])
